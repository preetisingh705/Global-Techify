...
import img1 from '../../../../assets/Allcourses/data-structure.png';
  ...
  const addItemToCart = ()=>{
    ...
    <div className="flex justify-center items-center"> <u className="text-[#785fd3] text-sm md:text-xl">Home</u>   
     ...
     <div className=" flex gap-x-8 font-poppins">
      ...
      <button className="border-[#f17b66] border-2 px-3 py-2 text-xl rounded-md flex gap-2" onClick={() =>addItemToCart()}>
       <FaHeart className="text-[#f17b66] text-[25px]" />       Favourite</button>

      <button className="bg-[#6a54dd] px-3 py-2 text-2xl text-white rounded-md"> Enroll Now </button>
     </div>
         ...
         <div class="flex justify-center items-center ">
           ...
           dark:bg-neutral-900 dark:border-[rgba(255,255,255,0.10)] border-[rgba(189,189,189,0.1)] border 
           shadow-md  backdrop-blur-md ">
                 ...
                 <div class="flex text-3xl gap-x-3 font-poppins flex-wrap items-center dark:text-white">
                   ...
                   <div class="dark:text-white">
                    ...
                    hover:border-[#7862E4] border hover:bg-white hover:text-[#7862E4]" href="">
                      Buy Now</a>
                    </div>
