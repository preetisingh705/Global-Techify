import teacher from "../../../assets/Mentor/mentor6.png"
...
function Instructor () {
    return (
        ...
        <div className="flex flex-col ">
           ...
           <p className="text-2xl  font-poppins dark:text-white">Amisha Prajapati</p>
         <p className="font-poppins dark:text-white"> Software Developer </p>
          
            <p className=" font-poppins dark:text-white">
             
              Indian Institute Of Technology BHU , Varansi </p>
