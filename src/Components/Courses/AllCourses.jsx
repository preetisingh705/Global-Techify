...
function AllCourses () {
    ...
    {/* Courses Heading name */}
      <div className='grid grid-cols-1 gap-4  font-Verdana  justify-center items-center mt-6'>
      <motion.div 
        ...
        viewport={{once: false, amount: 0.7}}
          ...
          <p className="text-[30px] lg:text-[40px] text-[#7862e4]  font-semibold leading-none">All COURSES</p>
